...
void USART3_IRQHandler(void)
{
  ...
  /* USER CODE BEGIN USART3_IRQn 1 */
	HAL_UART_Receive_DMA(&huart3,uart3_rx_buff,UART3_RXBUFFERSIZE); //开启DMA接收
...
void UART4_IRQHandler(void)
{
  ...
  /* USER CODE BEGIN UART4_IRQn 1 */
	HAL_UARTEx_ReceiveToIdle_DMA(&huart4,uart4_rx_buff,UART4_RXBUFFERSIZE);//开启UART6空闲中断，DMA接收测距数据
