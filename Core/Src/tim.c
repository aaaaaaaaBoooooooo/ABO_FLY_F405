...
{
  if(htim->Instance == TIM1)//��ʱ��1�ж� 1ms
	{
		pid_internal_control();//pid��̬�����ڻ�   ������PWMռ�ձ�
		motor_throttle_control();//���ſ���
    motor_control();
		if(tim1_cnt_5ms >= 5)
		{ 
      ...
      pid_external_control();
		...
		if(tim1_cnt_22ms >= 22)
		{
			aircraft_flight_Height_control();//�߶�pid����
			tim1_cnt_22ms =0;
		}		
		tim1_cnt_5ms++;
		tim1_cnt_22ms++;
	}
	else if(htim->Instance == TIM5)//��ʱ��5�ж� 10ms
	{
		rx_data_tim_cnt++;//����ң�����ݶ�ʱ����
